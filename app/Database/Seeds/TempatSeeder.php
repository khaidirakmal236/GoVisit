...
class TempatSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $tempat = [
            ...
            [
                'nama_tempat' => 'Danau Tambing',
                'kategori'    => 'wisata',
                'deskripsi'   => 'Danau alami yang berada di kawasan Taman Nasional Lore Lindu, udara sejuk dan pemandangan asri',
                'alamat'      => 'Jl. Dongi Dongi-Watumaeta, Sedoa, Kec. Lore Utara, Kabupaten Poso, Sulawesi Tengah 94653',
                'foto_utama'  => $this->cariFoto('Danau Tambing', null),
                'rating_avg'  => 4.7,
                'jam_buka'    => null,
                'maps_link'   => 'https://www.google.com/maps/place/M8G5%2B6F7+Danau+Tambing,+Jl.+Dongi+Dongi-Watumaeta,+Sedoa,+Kec.+Lore+Utara,+Kabupaten+Poso,+Sulawesi+Tengah+94653',
                'status'      => 'aktif',
                'created_at'  => $now,
                'updated_at'  => $now,
            ],
            ...
            [
                'nama_tempat' => 'Pisang Wijen Palu',
                'kategori'    => 'hidden_gem',
                'deskripsi'   => 'Hidden gem kuliner pisang wijen khas Palu',
                'alamat'      => 'Jl. Lalove, Nunu, Kec. Tatanga, Kota Palu, Sulawesi Tengah 94221',
                'foto_utama'  => $this->cariFoto('Pisang Wijen Palu', null),
                'rating_avg'  => 4.5,
                'jam_buka'    => null,
                'maps_link'   => 'https://maps.app.goo.gl/V9pWzYVxc8JES1HP7',
                'status'      => 'aktif',
                'created_at'  => $now,
                'updated_at'  => $now,
            ],
            [
                'nama_tempat' => 'Warung Jokotole',
                'kategori'    => 'hidden_gem',
                'deskripsi'   => 'Warung kuliner hidden gem dengan cita rasa khas',
                'alamat'      => 'Jl. Rajawali No.20, Lolu Utara, Palu Timur, Kota Palu, Sulawesi Tengah 94112',
                'foto_utama'  => $this->cariFoto('Warung Jokotole', null),
                'rating_avg'  => 4.6,
                'jam_buka'    => null,
                'maps_link'   => 'https://maps.app.goo.gl/RqjwdvaxqkbiPo757',
                'status'      => 'aktif',
                'created_at'  => $now,
                'updated_at'  => $now,
            ],
            [
                'nama_tempat' => 'RAQa River Camp',
                'kategori'    => 'hidden_gem',
                'deskripsi'   => 'Camping ground hidden gem di tepi sungai dengan tenda dan lampu string yang cozy',
                'alamat'      => 'Bale, Kec. Tanantovea, Kabupaten Donggala, Sulawesi Tengah 94352',
                'foto_utama'  => $this->cariFoto('RAQa River Camp', null),
                'rating_avg'  => 4.7,
                'jam_buka'    => null,
                'maps_link'   => 'https://maps.app.goo.gl/WahQj8qvwvyxRrkA9',
                'status'      => 'aktif',
                'created_at'  => $now,
                'updated_at'  => $now,
            ],
